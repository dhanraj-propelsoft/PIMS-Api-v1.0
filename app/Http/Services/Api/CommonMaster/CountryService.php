...
class CountryService
{
    ...
    public function index()
    {
        ...
        $entities = $models->map(function ($model) {
            ...
            $id = $model->id;
            $datas = ['country' => $country, 'numericCode' => $numericCode, 'phoneCode' => $phoneCode, 'capital' => $capital, 'flag' => $flag, 'description' => $description, 'status' => $status, 'activeStatus' => $activeStatus, 'id' => $id];
            return $datas;
        });
    ...
    public function store($datas)
    {
        ...
        $validator = Validator::make($datas, [
            'country' => ['required', Rule::unique('pims_com_countries', 'country'),],
            'numericCode' => [Rule::unique('pims_com_countries', 'numeric_code'),],
            'phoneCode' => [Rule::unique('pims_com_countries', 'phone_code'),],
            'capital' => [Rule::unique('pims_com_countries', 'capital'),],
        ]);
